...
--
insert into department (id, name, college_id) values((select next_val from id_sequences where sequence_name = 'department'), '일어일문학과', 1);
insert into department (id, name, college_id) values((select next_val from id_sequences where sequence_name = 'department')+1, '경영학과', 2);
insert into department (id, name, college_id) values((select next_val from id_sequences where sequence_name = 'department')+2, '컴퓨터공학과', 3);
insert into department (id, name, college_id) values((select next_val from id_sequences where sequence_name = 'department')+3, '사회복지학과', 4);
update id_sequences set next_val = next_val + 4 where sequence_name = 'department';

--
insert into student (id, name, gender, birth_date, address, email, tel, entrance_date, department_id)
values(23000001, '이문수', '남성', '1994-06-30', '인천시 연수구', 'lyczang44@naver.com', '010-4932-8161', now(), 101);
insert into user (id, password, role) values
(23000001, '$2a$12$Wq1J0hZZfYOryKHgYtu4nudF.lxnJzhAhGQC8HUBLRx2nMaTXOyxq', 'STUDENT');
update id_sequences set next_val = next_val + 1 where sequence_name = 'student';

--
insert into professor (id, name, gender, birth_date, address, email, tel, hire_date, department_id)
values(230001, '이은미', '여성', '1972-04-15', '서울시 서대문구', 'eunmi77@naver.com', '010-1234-5678', now(), 101);
insert into user (id, password, role) values
(230001, '$2a$12$OalzWbYZ0Et0/xGzEbDgs.Ui.bDovJEiYd4meiBwlvXs8PJtI3EmS', 'PROFESSOR');
